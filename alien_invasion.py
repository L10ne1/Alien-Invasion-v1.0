...
class AlienInvasion:
    ...
    def _update_bullets(self):
        """Обновляет позиции снарядоа и уничтожает страые снаряды."""
    ...
    def _create_fleet(self):
        ...
        # Создание пришельца и вычисление колличество пришельцев в ряду
        # Интервал между соседним пришельцеми равен ширине пришельца.
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
        alien_width = alien.rect.width  # А нужна ли эта строчка?
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:  # добавил self, но не уверен
